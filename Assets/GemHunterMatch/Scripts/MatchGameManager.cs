...
namespace Match3
{
    ...
    {
        //This is set to true when the manager is deleted. This is useful as the manager can be deleted before other objects 
        ...
        private static MatchGameManager s_Instance;
        ...
        /// <summary>
        /// Called by the LevelData when it awake, notify the MatchGameManager we started a new level.
        /// </summary>
        ...
        /// <summary>
        /// Called by the Main Menu when it open, notify the MatchGameManager we are back in the menu so need to hide the Game UI.
        /// </summary>
